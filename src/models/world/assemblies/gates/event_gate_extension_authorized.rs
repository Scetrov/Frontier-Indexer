...
use crate::schema::indexer::events_gate_extension_authorized;

#[derive(Deserialize)]
pub struct MoveGateExtensionAuthorized {
...
#[diesel(table_name = events_gate_extension_authorized)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct StoredGateExtensionAuthorized {
    pub event_id: String,

...
use crate::schema::indexer::events_fuel_burning_updated;

#[derive(Insertable, Debug, Clone, FieldCount)]
#[diesel(table_name = events_fuel_burning_updated)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct StoredFuelBurningUpdated {
    pub event_id: String,
